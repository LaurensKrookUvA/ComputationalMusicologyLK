...
***
The second visualization shows the progression of tempo over the playlist. On the x axis here the songs are numerically represented in playlist order. On the y axis, the tempo is shown.  The figures are analyzed by playlist. The first figure shows a wide range of tempos. 
...
Column
--------------------------------------------------------
### Valence, Energy, Loudness and mode
```{r}
